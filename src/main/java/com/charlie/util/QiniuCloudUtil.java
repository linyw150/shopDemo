...
public class QiniuCloudUtil {
    ...
    // 设置需要操作的账号的AK和SK
    private static final String ACCESS_KEY = "aN1wXZMptHfZwZmx2OkfmFI1kAHkA7EsWErkJTIA";
    private static final String SECRET_KEY = "4AM4vKL0njfaJXbR-laHSJ8wsNgVsampBnOr5jeP";

    // 要上传的空间
    private static final String bucketname = "shop_image";

    // 密钥
    private static final Auth auth = Auth.create(ACCESS_KEY, SECRET_KEY);
//
     private static final String DOMAIN = "http://pouon5nem.bkt.clouddn.com/";
//
